      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-white mb-2">Room Manager</h1>
            ...
            <CardContent>
              <form onSubmit={handleSignUp}>
                ...
                <div className="mt-4 text-center text-sm text-slate-400">
                  ...
                  <Link href="/auth/login" className="text-white underline underline-offset-4 hover:text-slate-200">
                    Login
                  </Link>
                </div>
              </form>
